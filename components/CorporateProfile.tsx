    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-bold">{corporateData.name}</h1>
            <p className="text-muted-foreground">{corporateData.industry} • {corporateData.location}</p>
          </div>
        </div>
        <div className="flex items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            ...
            <span className="font-medium">{corporateData.rating}</span>
          </div>
        </div>
      </div>
      ...
      <Tabs defaultValue="company-info" className="w-full">
        <TabsList className="grid w-full grid-cols-6">
          ...
          <TabsTrigger value="travel-profile">Travel Profile</TabsTrigger>
